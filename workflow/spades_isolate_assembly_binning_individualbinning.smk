...
rule mapping_prep:
    ...
    shell:
        ...
        bbmap.sh -Xmx50g threads={threads} ref={input} interleaved=true nodisk minid=0.98 in=data/interleave_DNA/{wildcards.sample}.interleave.fastq.gz out=results/{wildcards.sample}_spades/bams/{wildcards.sample}.bam
...
#        "envs/drep.yaml"
    ...
    shell:
        ...
        cp results/{wildcards.sample}_spades/scaffolds_1000bp.fa results/{wildcards.sample}_spades/final_bins
